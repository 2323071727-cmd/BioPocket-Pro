...
with st.sidebar:
    ...
    st.title("BioPocket")
    st.caption("v21.0 | Professional Edition")
    st.markdown("---")
            ...
            if not api_key: st.error("❌ 请先配置 API Key")
                ...
                try:
                    with st.spinner("🚀 正在匹配设备特征库..."):
                        ...
                        内容包括：1. 标准学术名称 (不要猜测品牌) 2. 核心功能简介 3. 安全操作规程 (SOP) 4. 潜在风险提示
                        """
